												...
												<div class="user-content">
													...
													<div class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-end">
															<?php
															echo "<a class='dropdown-item' href='team_delete?id=$id&image=$image'>Delete</a>";
															echo "<button class='dropdown-item' type='button' method='POST' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#exampleModal2'>Edit</button>";
															?>
