                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="{% static 'admin/images/no-img-avatar.png' %}" alt="">
                                </div>
                            </a>
                                ...
                                <div class="card mb-0">
                                    <div class="card-header p-3">
                                        <ul class="d-flex align-items-center">
                                            <li>
                                                <img src="{% static 'admin/images/no-img-avatar.png' %}" class="ms-0" alt="">
                                            </li>
                                            <li class="ms-2">
                                                <h4 class="mb-0 text-capitalize">{{user.username}}</h4>
